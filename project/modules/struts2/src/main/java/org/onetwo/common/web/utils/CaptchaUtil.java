...
public class CaptchaUtil {
	...
	public static boolean isValid(HttpServletRequest request, String captcha) {
		String value = CookieUtil.getCookieValue(request, CaptchaUtil.CAPTCHA_KEY);
		if(value != null && value.equals(new MD5().calcMD5(captcha))) {
			return true;
		}
		return false; 
	}
	
	public static void setCaptcha2Cookie(String key, String captcha){
		CookieUtil.setCookie(key, MDFactory.getMDEncrypt().encryptWithSalt(captcha));
	}
}
