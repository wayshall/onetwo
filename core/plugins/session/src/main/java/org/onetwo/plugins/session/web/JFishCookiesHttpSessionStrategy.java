...
//        return request.getContextPath() + "/";
    ...
    class MultiSessionHttpServletResponse extends HttpServletResponseWrapper {
        ...
        public String encodeRedirectURL(String url) {
            ...
            return JFishCookiesHttpSessionStrategy.this.encodeURL(url, getCurrentSessionAlias(request));
        }
        ...
        public String encodeURL(String url) {
            ...
            return JFishCookiesHttpSessionStrategy.this.encodeURL(url, alias);
        }
    }
