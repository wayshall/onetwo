...
public abstract class AbstractHttpSessionApplicationInitializer implements WebApplicationInitializer {
    ...
    protected void registerAnnotationConfigClasses(ServletContext servletContext, Class<?>[] configurationClasses){
    	ApplicationContext app = SpringApplication.getInstance().getAppContext();
		if(AnnotationConfigWebApplicationContext.class.isInstance(app)){
			((AnnotationConfigWebApplicationContext) app).register(configurationClasses);
		}else{
    ...
    public void onStartup(ServletContext servletContext)
        ...
        if(configurationClasses != null) {
            ...
            rootAppContext.register(configurationClasses);
            servletContext.addListener(new ContextLoaderListener(rootAppContext));*/
        	registerAnnotationConfigClasses(servletContext, configurationClasses);
        }
