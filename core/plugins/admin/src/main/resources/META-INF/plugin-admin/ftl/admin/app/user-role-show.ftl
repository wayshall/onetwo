...
分配角色
     ...
     <@widget.form name="user" method="put">
     	...
     	<@widget.formField name="roleIds" label="角色" cssStyle="width:400px" type="checkboxGroup" items=roles itemLabel="name" itemValue="id" value="isBindTheRole" errorTag="roles"/>
