<@extends>
	...
	<@override name="main-content">
	 	...
	 	<@widget.form name="taskQueue" action="${pluginConfig.baseURL}/taskqueue/email" method="post" label="新建邮件任务" uploadFile=true>
	 		...
	 		<@widget.formField name="attachment" label="附件" type="file" modelAttribute=false errorTag="false"/>
