...
//				$(form).append(params_input);
		...
		init : function(){
			$('body').on('click', jfish.cssKeys.showTipsElement, function(){
				$.showTipsWindow($(this).attr('show-tips'));
			})
			
			$('body').on('click', jfish.cssKeys.showBlockMsgElement, function(){
				$.showBlockMsg($(this).attr('show-block'));
			})
			
			$('body').on('click', jfish.cssKeys.linkButton, function(){
			...
			$('body').on('click', jfish.cssKeys.formButton, jfish.handleFormFunc(null, null, true));
			
			$('body').on('click', '.jfish-toggle-control', function(){
				var $this = $(this);
		...
		setCheckboxEvent: function(formName){
			...
			$('body').on('click', childBox, function(){
				var checkeds = $("input[type='checkbox'][id!='"+checkboxAll.attr("id")+"'][checked]", form);
				checkboxAll.attr("checked", (checkeds.length==$(jfish.cssKeys.checkField, form).length));
			});
		},
