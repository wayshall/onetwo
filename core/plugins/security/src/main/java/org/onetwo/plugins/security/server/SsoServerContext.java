...
public class SsoServerContext implements InitializingBean {
	...
	public static final String SSO_SERVER_BASE = "/plugins/security/server-config";
...
//		SecurityPlugin.getInstance().setSecurityConfig(ssoServerConfig);
	...
	@Bean
	public SsoServerConfig ssoServerConfig(){
//		return ssoServerConfig;
		return (SsoServerConfig)SecurityPlugin.getInstance().getSsoConfig();
	}
