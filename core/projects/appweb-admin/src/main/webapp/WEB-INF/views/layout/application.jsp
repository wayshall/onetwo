...
<html lang="zh">
	<head>
	    <meta charset="utf-8">
	    <title>
			<layout:define name="title">欢迎使用jfish</layout:define>
	    </title>
	    ...
	    <!--[if lte IE 6]>
  <link rel="stylesheet" type="text/css" href="${siteConfig.cssPath}/bootstrap/2.3.2/css/bootstrap-ie6.css">
  <![endif]-->
  <!--[if lte IE 7]>
  <link rel="stylesheet" type="text/css" href="${siteConfig.cssPath}/bootstrap/2.3.2/css/ie.css">
  <![endif]-->
...
<c:if test="${themeSetting.jsui}">
  ...
  <script type="text/javascript" src="${siteConfig.cssPath}/bootstrap/2.3.2/js/bootstrap-ie.js?t=${now.millis}"></script>
  <script>
