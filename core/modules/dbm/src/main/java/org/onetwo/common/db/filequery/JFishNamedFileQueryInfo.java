...
/*
	...
	@Override
	public JFishNamedFileQueryInfo clone() throws CloneNotSupportedException {
		JFishNamedFileQueryInfo prop = new JFishNamedFileQueryInfo();
		this.cloneProperties(prop);
		return prop;
	}

	protected void cloneProperties(JFishNamedFileQueryInfo prop) {
