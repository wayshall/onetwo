...
//														.stripTablePrefix("em_")
														...
														.globalConfig()
															.pageFileBaseDir($/D:\mydev\java\workspace\bitbucket\product-manager\resources\templates/$)
...
//														.table("")
															...
															.controllerTemplate("${basePath}/db/generator/product/Controller.java.ftl")
