...
//		UnderlineBean target = CopyUtils.copy(UnderlineBean.class, srcBean);
		...
		UnderlineBean target = copier.fromObject(srcBean, UnderlineBean.class);
	...
	public void testCopyList(){
		...
		List<CapitalBean2> datas = new ArrayList<CopyUtilsTest2.CapitalBean2>();
		datas.add(srcData);
...
//			UnderlineBeanWithoutCloneable underlineBeanWithoutCloneable = CopyUtils.copy(UnderlineBeanWithoutCloneable.class, srcBean);
			UnderlineBeanWithoutCloneable underlineBeanWithoutCloneable = copier.fromObject(srcBean, UnderlineBeanWithoutCloneable.class);
...
//		srcBean = CopyUtils.copy(new CapitalBean(), target);
		srcBean = copier.fromObject(srcBean, new CapitalBean());
