...
public abstract class Objects {
	...
	public static int reflectionHashCode(Object obj) {
	    ...
	    if (isArrayOfPrimitives(obj) || isPrimitiveOrWrapper(targetClass)) {
	...
	/**
	 * Returns <code>true</code> if the given object is an array of
	 * primitives.
	 * 
	 * @param array
	 *            the given object to check.
	 * @return <code>true</code> if the given object is an array of
	 *         primitives.
	 */
	 ...
	 * @param clazz
	 *            the given class.
	 * @return <code>true</code> if the given class represents a primitive or
	 *         a wrapper, <code>false</code> otherwise.
	 */
	 ...
	 * <p>
	 * Returns a hash code based on the contents of the specified array. For any
	 * two <code>double</code> arrays <code>a</code> and <code>b</code>
	 * such that <code>Arrays.equals(a, b)</code>, it is also the case that
	 * <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
	 * </p>
	 * 
	 ...
	 * <p>
	 * Returns a hash code based on the contents of the specified array. For any
	 * two <code>float</code> arrays <code>a</code> and <code>b</code>
	 * such that <code>Arrays.equals(a, b)</code>, it is also the case that
	 * <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
	 * </p>
	 * 
	 ...
	 * <code>array</code> is <code>null</code>, in which case
	 ...
	 * <p>
	 * Returns a hash code based on the contents of the specified array. For any
	 * two <code>short</code> arrays <code>a</code> and <code>b</code>
	 * such that <code>Arrays.equals(a, b)</code>, it is also the case that
	 * <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
	 * </p>
	 * 
