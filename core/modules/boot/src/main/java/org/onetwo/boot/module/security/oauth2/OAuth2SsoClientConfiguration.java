...
public class OAuth2SsoClientConfiguration extends OAuth2SsoDefaultConfiguration {	
	protected final ApplicationContext applicationContext;

	/*@Autowired
	OAuth2ClientContext oauth2ClientContext;*/
	
	public OAuth2SsoClientConfiguration(ApplicationContext applicationContext, OAuth2SsoProperties sso) {
	...
	protected void configure(HttpSecurity http) throws Exception {
		this.configClientSsoFilter(http);
	}
	protected void configClientSsoFilter(HttpSecurity http) throws Exception {
