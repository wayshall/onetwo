...
public class MapTest {
	...
	@Test
	public void testDiffentMap(){
		Map params1 = JSONUtils.getJsonMap(jsonString);
		Map params2 = JSONUtils.getJsonMap(jsonString2);
		CasualMap c1 = new CasualMap(params1);
		CasualMap c2 = new CasualMap(params2);
		Map c3 = c1.diffence(c2);
		LangUtils.println("intersection:", c3);
		c3 = M.subtract(c1, c2);
		LangUtils.println("subtract:", c3);
		c3 = M.subtract(c2, c1);
		LangUtils.println("subtract2:", c3);
	}
