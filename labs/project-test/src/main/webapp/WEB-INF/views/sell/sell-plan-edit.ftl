...
SellPlan ${sellPlan.id} 编辑
	...
	<@form.form modelAttribute="sellPlan" action="${siteConfig.baseURL}/sell/sellplan/${sellPlan.planId}" method="put">
	
		<input name="planId" type="hidden" value="${sellPlan.planId}"/>
