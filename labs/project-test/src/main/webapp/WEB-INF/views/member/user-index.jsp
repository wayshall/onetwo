...
<layout:extends>	
 ...
 <layout:override name="main-content">
	...
	<layout:override name="grid_toolbar">
		<li>
			<a href="${siteConfig.baseURL}/member/user/new"> 新 建  </a>
			</li>
			<li>
			<a data-method="delete" class="dg-toolbar-button-delete" data-confirm="确定要批量删除这些数据？" href="${siteConfig.baseURL}/member/user"> 批量删除  </a>
		</li>
	</layout:override>
	...
	<widget:dataGrid name="usergrid" dataSource="${page}" title="用户列表" toolbar="true">
		<widget:dataRow name="entity" type="iterator" renderHeader="true">
			...
			<widget:dataField name="operation" label="操作" render="html">
				<a href="${siteConfig.baseURL}/member/user/${entity.id}/edit">编辑</a>
			</widget:dataField>
		</widget:dataRow>
	</widget:dataGrid>
